...
AnT::Range - Object representing a region of DNA, RNA or protein
sequence
...
An AnT::Range object represents a region of DNA, RNA or protein
sequence. AnT::Range objects reside within AnT::Feature objects
where they describe the region(s) belonging to the feature.

The object provides methods for setting and returning start, end,
strand etc.
...
=head2 new
 ...
 Title   : new
 Usage   : $range = AnT::Range->new(-start => 100, -end => 400);
 Function: Creates an AnT::Range object which represents a single
         : contiguous range of residues
 Returns : A new AnT::Range object
 Args    : -start, -fuzzy_start, -end, -fuzzy_end as integers
         : -no_5prime, -no_3prime, -no_width as 0 or 1,
         : -strand as -1, 0 or 1
...
=head2 _trim
 ...
 Title   : _trim
 Usage   : N/A
 Function: Trims an AnT::Range object given a new start and end
         : sequences coordinates as boundaries. This method is
         : alpha code and may well have bugs
 Returns : None
 Args    : New start and end as integers
...
=head2 _mark_trimmed
 ...
 Usage   : N/A
 Function: Marks an AnT::Range object with no_3prime and/or
