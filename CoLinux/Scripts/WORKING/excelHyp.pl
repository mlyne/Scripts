...
#
# reverse('<A9>'), March 2001, John McNamara, jmcnamara@cpan.org
#
...
$worksheet->write('A3', 'http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?db=PubMed&term=macrophage+AND+Trovafloxacin[title/abstract]', '5'   );
