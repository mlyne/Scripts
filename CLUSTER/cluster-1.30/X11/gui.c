...
{   
    ...
    {   case ID_SOM_INIT:
	    ...
	    page = w;
            ...
            XtManageChild(widget);
            XtAddCallback(widget, XmNactivateCallback, SOM, (XtPointer)ID_SOM_EXECUTE);
	    break;
        }
        case ID_SOM_EXECUTE:
...
{   
    ...
    {   case ID_FILTER_INIT:
	    ...
	    page = w;
            ...
            XtManageChild(widget);
            XtAddCallback(widget, XmNactivateCallback, Filter, (XtPointer)ID_FILTER_APPLY);
            n = 0;
            ...
            XtAddCallback(widget, XmNactivateCallback,
		          Filter, (XtPointer)ID_FILTER_ACCEPT);
            n = 0;
	    ...
	    Filter(page, (XtPointer)ID_FILTER_RESET, NULL);
        ...
        {   /* Accept results of last filtering */
            ...
            FileManager(NULL, (XtPointer)ID_FILEMANAGER_UPDATE_ROWS_COLUMNS, NULL);
	    SOM(w, (XtPointer)ID_SOM_UPDATE, NULL);
	    break;
	}
...
{   
    ...
    {   case ID_ADJUST_INIT:
	    ...
	    page = w;
            ...
            XtManageChild(widget);
            XtAddCallback(widget, XmNactivateCallback, Adjust, (XtPointer)ID_ADJUST_EXECUTE);
...
{   
    ...
    {   case ID_KMEANS_INIT:
	    ...
	    page = w;
            ...
            XtManageChild(widget);
            XtAddCallback(widget, XmNactivateCallback, KMeans, (XtPointer)ID_KMEANS_EXECUTE);
	    break;
        }
...
{   
    ...
    {   case ID_PCA_INIT:
	    ...
	    page = w;
            ...
            widget = XmCreatePushButton(page, "Execute", args, n);
            XtManageChild(widget);
            XtAddCallback(widget, XmNactivateCallback, PCA, (XtPointer)ID_PCA_EXECUTE);
            n = 0;
...
{   char* filename = NULL;
    ...
    *directory = (char*)XmStringUnparse(cbs->dir,
    ...
    {   char buffer[256];
        ...
        Statusbar(NULL, buffer);
        FileManager(NULL, (XtPointer)ID_FILEMANAGER_SET_FILEMEMO, "");
        FileManager(NULL, (XtPointer)ID_FILEMANAGER_SET_JOBNAME, "");
        FileManager(NULL, (XtPointer)ID_FILEMANAGER_UPDATE_ROWS_COLUMNS, NULL);
    }
    else
    {   /* Extract job name from file name */
        ...
        FileManager(NULL, (XtPointer)ID_FILEMANAGER_SET_FILEMEMO, filename);
        if(extension) *extension = '\0';
        FileManager(NULL, (XtPointer)ID_FILEMANAGER_SET_JOBNAME, jobname);
        FileManager(NULL, (XtPointer)ID_FILEMANAGER_UPDATE_ROWS_COLUMNS, NULL);
        Filter(NULL, (XtPointer)ID_FILTER_RESET, NULL);
        SOM(w, (XtPointer)ID_SOM_UPDATE, NULL);
...
{   static char* directory = NULL;
	...
	{   static Widget dialog = NULL;
        ...
        {   if(directory) free(directory);
            Free();
            Filter(NULL, (XtPointer)ID_FILTER_FREE, NULL);
	    exit(0);
            break;
        }
    }
...
{
    static Widget page = 0;
    const int which = (int) client_data;
    switch(which)
    {   case ID_HIERARCHICAL_INIT:
        {   Arg args[5];
            ...
            XtManageChild(widget);
            XtAddCallback(widget, XmNactivateCallback, Hierarchical, (XtPointer)ID_HIERARCHICAL_CENTROID);
            n = 0;
            XtSetArg(args[n], XmNx, 160); n++;
            XtSetArg(args[n], XmNy, 243); n++;
            widget = XmCreatePushButton(page, "Single linkage", args, n);
            XtManageChild(widget);
            XtAddCallback(widget, XmNactivateCallback, Hierarchical, (XtPointer)ID_HIERARCHICAL_SINGLE);
            n = 0;
            XtSetArg(args[n], XmNx, 290); n++;
            XtSetArg(args[n], XmNy, 243); n++;
            widget = XmCreatePushButton(page, "Complete Linkage", args, n);
            XtManageChild(widget);
            XtAddCallback(widget, XmNactivateCallback, Hierarchical, (XtPointer)ID_HIERARCHICAL_COMPLETE);
            n = 0;
            XtSetArg(args[n], XmNx, 425); n++;
            XtSetArg(args[n], XmNy, 243); n++;
            widget = XmCreatePushButton(page, "Average Linkage", args, n);
            XtManageChild(widget);
            XtAddCallback(widget, XmNactivateCallback, Hierarchical, (XtPointer)ID_HIERARCHICAL_AVERAGE);
            n = 0;
            XtSetArg(args[n], XmNx, 10); n++;
...
{   Widget notebook, page, scroller;
	...
	switch (i) {
	    case 0: Filter(page, (XtPointer)ID_FILTER_INIT, NULL); break;
	    case 1: Adjust(page, (XtPointer)ID_ADJUST_INIT, NULL); break;
	    case 2: Hierarchical(page, (XtPointer)ID_HIERARCHICAL_INIT, NULL); break;
	    case 3: KMeans(page, (XtPointer)ID_KMEANS_INIT, NULL); break;
	    case 4: SOM(page, (XtPointer)ID_SOM_INIT, NULL); break;
	    case 5: PCA(page, (XtPointer)ID_PCA_INIT, NULL); break;
	}
	n = 0;
...
{   Widget work, statusbar, widget;
    ...
    XmString open_str = XmStringCreateLocalized("Open data file");
    XmString save_str = XmStringCreateLocalized("Save data file");
    XmString quit_str = XmStringCreateLocalized("Quit");
    XmString help_str = XmStringCreateLocalized("Help");
    XmString local_str = XmStringCreateLocalized("Read local manual");
    XmString online_str = XmStringCreateLocalized("Read online manual");
    XmString format_str = XmStringCreateLocalized("File format help");
    ...
    XmVaCreateSimplePulldownMenu(menubar, "file_menu", CMD_FILE_OPEN, MenuFile,
    ...
    XmVaCreateSimplePulldownMenu(menubar, "help_menu", CMD_FILE_SAVE, MenuHelp,
			          XmVaPUSHBUTTON, help_str, 'H', NULL, NULL,
			          XmVaPUSHBUTTON, local_str, 'M', NULL, NULL,
			          XmVaPUSHBUTTON, online_str, 'O', NULL, NULL,
			          XmVaPUSHBUTTON, format_str, 'F', NULL, NULL,
				  XmVaSEPARATOR,
    ...
    XmStringFree(online_str);
    XmStringFree(format_str);
    ...
    FileManager(work, (XtPointer)ID_FILEMANAGER_INIT, NULL);
    InitTabpages(work);
    ...
    XmAddWMProtocolCallback(top, atom, MenuFile, (XtPointer)CMD_FILE_EXIT);
