...
Human Genome Center (currently at Columbia University, Center for Computational
Biology and Bioinformatics; mdehoon@c2b2.columbia.edu). The core numerical
routines are now located in the C clustering library; this program mainly
constains gui-related routines. Instead of the Borland C++ Builder, the GNU C
compiler under Cygwin/MinGW was used.
MdH 2002.06.13.
*/
