...
my $usage = "Usage:pmID2abst PMID_file out_file\n
...
defined $opts{"x"} and $xml++;

my $delay = 0;
my $maxdelay = 3;
my $base = "http://eutils.ncbi.nlm.nih.gov/entrez/eutils/";
my ($retMod) = ($xml ? "xml" : "text");
my $inFile = $ARGV[0];
my $outFile = ($ARGV[1] ? $ARGV[1] : "pmAbst_tmp.txt");
...
open(INPUT, "<$inFile") || die "Aborting. Can't open $inFile\n";
