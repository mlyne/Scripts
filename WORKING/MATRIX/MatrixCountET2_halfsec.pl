...
my $usage = "Usage:MatrixCountET_halfsec.pl termRE_file\n

Options:
\t-h\tThis help
\t-n\tsuppress time check\n";
...
# Check the time ###
Time_Check() unless ($noTime); ### take out for testing
...
# Write Co-oc frequencies to Text file
		print OUT_FILE $hitCount, "\t", $drugName;
