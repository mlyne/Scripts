...
HTML_TEMPLATE = '../Mining-the-Social-Web/web_code/protovis/linkedin_tree.html'

# Another option for a template
#HTML_TEMPLATE = '../Mining-the-Social-Web/web_code/protovis/linkedin_dendogram.html'
...
shutil.copytree('../Mining-the-Social-Web/web_code/protovis/protovis-3.2',
                'out/protovis-3.2')
