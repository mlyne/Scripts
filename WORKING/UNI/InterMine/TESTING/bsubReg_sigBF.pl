...
$query->add_view(qw/
    primaryIdentifier
    sigmaBindingFactors.primaryIdentifier.primaryIdentifier
    sigmaBindingFactors.primaryIdentifier.symbol
...
#    print $row->{'primaryIdentifier'},
      print $row->{'sigmaBindingFactors.primaryIdentifier.primaryIdentifier'},
        $row->{'sigmaBindingFactors.primaryIdentifier.symbol'}, $row->{'gene.primaryIdentifier'},
        $row->{'gene.symbol'}, $row->{'evidence.publications.pubMedId'}, $row->{'sequence.residues'}, "\n";
}