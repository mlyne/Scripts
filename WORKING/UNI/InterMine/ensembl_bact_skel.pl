...
my $lookup = Bio::EnsEMBL::LookUp->new(-FILE=>"/home/ml590/MIKE/InterMine/SynBioMine/DataSources/Ensembl/reg.json",-NO_CACHE=>1);
...
### ML added - load TAB file with species/ taxon info
...
print Dumper($slices);
    ...
    {       # Ugly, but supposedly more memory-efficient way of doing things
        ...
        my $chromosome_name = $chromosome->coord_system()->version();
        next
